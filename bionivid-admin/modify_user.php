    ...
    <head>
            ...
            */
            ...
            (min-device-width: 768px) and (max-device-width: 1024px)  {
                ...
                */
                ...
                .usview td:nth-of-type(3):before { content: "Phone"; }
                .usview td:nth-of-type(4):before { content: "Designation"; }
                .usview td:nth-of-type(5):before { content: "Address"; }
            }
        ...
        <script>
            function onChange()
            {
                ...
                document.location.href = "./modify_user.php?client=" + string;

            }

            function getSelected() {
                var radio_1 = document.getElementsByName("user");
                    ...
                    <div class="wrapper p9">
                        ...
                        <div class="wrapper">
                            <table class="usview">
                                ...
                                <?php
                                $rowNo = 0;
                                $result1 = $dbObject->selectExecute("SELECT * FROM users where user_clientname=\"" . $clientname . "\"");
                                foreach ($result1 as $row) {
                                    ...
                                    echo "<td>" . $row['user_designation'] . "</td>";
                                    echo "<td>" . $row['user_address'] . "</td>";
                                    echo "<td><input type=\"radio\" id=\"selected\" name=\"user\" value=\"" . $row['user_id'] . "\"></td>";
                                    echo "</tr>";
                                }
                                ?>
