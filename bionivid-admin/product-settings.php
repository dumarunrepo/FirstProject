          ...
          <div class="content-inner1 p6">
                <div class="aligncenter">
                                    ...
                                    if (isset($_GET['status'])) {
                                        if ($_GET['status'] == 0) {
                                            echo "<div class=\"success\">Product notification added Successfully </div>";
                                        } else if ($_GET['status'] == 1) {

                                            echo "<div class=\"failure\"><h6><font size=\"1\" color=\"red\">Unable to add product notification! Please try again later </font></h6></div>";
                                        }
                                    }
                                    ?>     
                                </div>
            ...
            <div class="wrapper">
              ...
              <?php
               ...
               <input type="submit" name="product_submit" id="notification_submit" value="Save" class="adc_submit" />
               </form>
              </div>
